# Writes frontend Cart.jsx
from pathlib import Path

CART = r'''import { useState, useEffect, useMemo } from 'react';
      ...
      <Card className="p-5 space-y-4">
        ...
        <div className="pt-2 flex flex-wrap gap-2 justify-end">
          ...
          >
            ...
            {creating ? 'Creating' + String.fromCharCode(2026) : 'Create RFQ'}
          </Button>
        </div>
        {!canSubmitRfq && (
...
if __name__ == "__main__":
    r = Path(__file__).resolve().parent.parent.parent / "frontend" / "src" / "pages" / "Cart.jsx"
    r.write_text(CART, encoding="utf-8")
    print("Wrote", r)
